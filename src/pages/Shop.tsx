            ...
            <aside className="hidden md:block w-64 flex-shrink-0">
              <div className="sticky top-24">
                <div className="bg-white rounded-lg shadow-sm border border-BloomBook-100 p-6">
                  ...
                  <div className="mb-6">
                    <h3 className="font-medium text-lg text-BloomBook-900 mb-4">Sort by</h3>
                    <select 
                      value={sortBy}
                      onChange={handleSortChange}
                      className="w-full text-sm border border-BloomBook-200 rounded-md py-2 px-3 text-BloomBook-900 focus:outline-none focus:ring-2 focus:ring-BloomBook-500"
                    >
